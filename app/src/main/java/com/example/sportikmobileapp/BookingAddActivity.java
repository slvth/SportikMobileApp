...
public class BookingAddActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(resultCode==RESULT_OK && arguments.getSerializable(BookingDetailModel.class.getSimpleName())!=null) {
    ...
    private void saveBooking(){
        ...
        if (connection != null) {
            ...
            totalSum = inventoryAddAdapter.getTotal();
            ...
            String sqlQueryInsert = "INSERT INTO Заявка (Дата_подачи, Дата_начала, Дата_окончания, ПользовательID, СотрудникID, Итоговая_стоимость, Статус_бронированияID) VALUES\n" +
                    "('"+todayString+"', '"+startDateString+"', '"+endDateString+"', 1, 2, "+totalSum+", 4)  RETURNING ЗаявкаID";
